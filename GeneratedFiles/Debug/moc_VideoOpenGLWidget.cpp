...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoOpenGLWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VideoOpenGLWidget_t qt_meta_stringdata_VideoOpenGLWidget = {
    {
...
static const uint qt_meta_data_VideoOpenGLWidget[] = {
...
QT_INIT_METAOBJECT const QMetaObject VideoOpenGLWidget::staticMetaObject = { {
    &QOpenGLWidget::staticMetaObject,
    qt_meta_stringdata_VideoOpenGLWidget.data,
    qt_meta_data_VideoOpenGLWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VideoOpenGLWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoOpenGLWidget.stringdata0))
